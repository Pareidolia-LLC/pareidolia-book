...
| 04 | A Case for Forecast Events | static memo in `build.py` | nothing, edit the markup |
| 05 | Xbox Takeover | static memo in `build.py` | nothing, edit the markup |
...
Concepts 04 and 05 are **brief static memos**, each rebuilt from one of Laskoskie's decks: A Case
