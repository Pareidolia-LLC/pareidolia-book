...
<div class="wrap"><div class="sheet">
  ...
  <div class="panel" id="panel-ideation">
    <nav class="cnav" id="cnav" role="tablist" aria-label="Concepts">
      ...
      <button type="button" class="cbtn" data-c="analytics" role="tab">Concept 03<b>Data Analytics</b></button>
      <button type="button" class="cbtn" data-c="insops" role="tab">Concept 04<b>Insurance Operations</b></button>
      <button type="button" class="cbtn" data-c="market" role="tab">Concept 05<b>Market Overview</b></button>
      <button type="button" class="cbtn" data-c="forecast" role="tab">Concept 06<b>Forecast Events</b></button>
      <button type="button" class="cbtn" data-c="xbox" role="tab">Concept 07<b>Xbox Takeover</b></button>
      <button type="button" class="cbtn" data-c="futuresight" role="tab">Concept 08<b>Futuresight Index</b></button>
      <button type="button" class="cbtn" data-c="value" role="tab">Concept 09<b>Value Scanner</b></button>
      <button type="button" class="cbtn" data-c="growth" role="tab">Concept 10<b>Quality Growth</b></button>
    </nav>
    ...
    <div class="concept" id="con-analytics">
      <div class="eyebrow">Concept 03 &middot; analytics &amp; underwriting &middot; Apr 27, 2023</div>
    ...
    <div class="concept" id="con-insops">
      <div class="eyebrow">Concept 04 &middot; operating plan &middot; May 5, 2023</div>
    ...
    <div class="concept" id="con-market">
      <div class="eyebrow">Concept 05 &middot; market brief &middot; Aug 31, 2023</div>
    ...
    <div class="concept" id="con-forecast">
      <div class="eyebrow">Concept 06 &middot; memo &middot; USD/JPY case study</div>
    ...
    <div class="concept" id="con-xbox">
      <div class="eyebrow">Concept 07 &middot; memo &middot; game theory design project &middot; July 2026</div>
      <h2>Xbox Takeover</h2>
    ...
    <div class="eyebrow">Concept 08 &middot; opened Aug 2026 &middot; forward-tracked</div>
    ...
    <div class="concept" id="con-value">
      <div class="eyebrow">Concept 09 &middot; deep value screen &middot; run <span id="vsRun"></span></div>
      <h2>Value Scanner</h2>
    ...
    <div class="concept" id="con-growth">
      <div class="eyebrow">Concept 10 &middot; quality growth screen &middot; run <span id="gsRun"></span></div>
  ...
  (function(){
    ...
    btns.forEach(function(b){
      b.addEventListener("click",function(){
        ...
        ["riskmgmt","riskfinal","analytics","insops","market","forecast","xbox","futuresight","value","growth"].forEach(function(k){
...
if vs is None:
    print("warning: valuescan.json missing - run valuescan_sync.py; Concept 09 will render empty")
...
if gs is None:
    print("warning: growthscan.json missing - run growthscan_sync.py; Concept 10 will render empty")
