  ...
  *{box-sizing:border-box}
  ...
  @media (prefers-reduced-motion:no-preference){
    ...
    .mark .ch{display:inline-block; animation:chOn .3s steps(3) both;
      animation-delay:calc(.12s + var(--i,0)*.045s)}
    .mark{animation:flick 13s steps(1) 4s infinite}
    .tag{animation:snapOn .01s steps(1) both .68s}
    .dateline span{animation:snapOn .01s steps(1) both}
  .dateline span:nth-child(1){animation-delay:0.760s}
  .dateline span:nth-child(2){animation-delay:0.840s}
  .dateline span:nth-child(3){animation-delay:0.920s}
    .tab{animation:snapOn .01s steps(1) both}
    .tabs.hasink .tabink{animation:snapOn .01s steps(1) both .92s}
  .tab:nth-child(1){animation-delay:0.920s}
  .tab:nth-child(2){animation-delay:0.990s}
  .tab:nth-child(3){animation-delay:1.060s}
  .tab:nth-child(4){animation-delay:1.130s}
    .statusbar span{animation:snapOn .01s steps(1) both}
  .statusbar span:nth-child(1){animation-delay:1.150s}
  .statusbar span:nth-child(2){animation-delay:1.210s}
  .statusbar span:nth-child(3){animation-delay:1.270s}
  .statusbar span:nth-child(4){animation-delay:1.330s}
  .statusbar span:nth-child(5){animation-delay:1.390s}
  .statusbar span:nth-child(6){animation-delay:1.450s}
    ...
    .reveal .eyebrow::before,.reveal .eyebrow::after{transform:scaleX(0); transform-origin:left}
    .reveal.seen .eyebrow::before{transform:scaleX(1); transition:transform .22s steps(4) .32s}
    .reveal.seen .eyebrow::after{transform:scaleX(1); transition:transform .45s steps(10) .4s}
...
(function(){
  ...
  (function(){
    ...
    if(!still){
      ...
      setTimeout(function(){ document.documentElement.classList.add("booted"); }, 1900);
