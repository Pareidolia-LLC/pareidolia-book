...
<style>
  ...
  *{box-sizing:border-box}
  ...
  /* the panel is already in place when the halves part; a short settle only */
  @keyframes push{from{opacity:0; transform:translateY(4px)}to{opacity:1; transform:none}}
  .panel{display:none}
...
(function(){
  ...
  (function(){
    ...
    function activate(id){
      ...
      setTimeout(function(){ wipe.classList.remove("run"); running=false; }, 590);
    }
