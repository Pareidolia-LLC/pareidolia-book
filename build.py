...
<div class="wrap"><div class="sheet">
  ...
  <section aria-label="Approach">
    ...
    <div class="cards" style="margin-top:16px">
      ...
      <div class="appr"><h3><span class="idx">C</span>Directional</h3><p>Outright risk, taken rarely. A thesis, a target, and a stop marked before the order goes in. Conviction gets sized against the book, never talked up after the fill.</p><p class="ctl"><b>Control</b> · entry, target and exit set before the fill</p></div>
    </div>
